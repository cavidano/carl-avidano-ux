...
caseStudy:
  ...
  roleAndContributions:
    - Led the branding, user experience, and front-end development
    - Redesigned the Visionlearning logo and visual identity
    - Designed and built responsive templates for English and Spanish content
    - Created interactive tools for glossary terms, science standards, and the Periodic Table
    - Developed a reusable front-end design system
    - Produced scientific illustrations for biology and chemistry modules
---
