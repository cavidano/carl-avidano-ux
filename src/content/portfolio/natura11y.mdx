...
description: "Creation, maintenance, and documentation of an open-source design ecosystem."
primaryColor: '#0d5056'
...
caseStudy:
  ...
  roleAndContributions:
    - Created and continue to lead the Natura11y open-source design ecosystem
    - Designed the monorepo architecture linking Core, React, Icons, documentation, and Storybook
    - Built accessible component patterns in Sass, CSS, vanilla JavaScript, and React
    - Created Figma UI kits and icon assets aligned with the production components
    - Wrote and designed the Astro documentation, templates, and examples
    - Manage testing, versioning, and package releases through npm and CDNs
---
