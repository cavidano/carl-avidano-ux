...
[The Drawing Board](https://avidanodigital-team.atlassian.net/wiki/spaces/CAU/pages/21954562/The+Drawing+Board) in the Carl Avidano UX space contains five main working article copies. On September 20, 2026, these were synchronized with the current MDX article bodies, editorial dates, single primary topics, section headings, figures in article order, captions, useful-link labels and destinations, and footer links. The four published articles and the CCF foundation draft are included; the separate logo draft has no main Confluence copy.
